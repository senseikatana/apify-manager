...
const area = {
     ...
     * ```
     */
    useRectangle(width, height, options) {
     ...
     * ```
     */
    useTriangle(base, height, options) {
     ...
     * ```
     */
    useTrapezoid(parallelSide1, parallelSide2, height, options) {
     ...
     * ```
     */
    useEllipse(semiMajor, semiMinor, options) {
     ...
     * ```
     */
    useParallelogram(base, height, options) {
...
const perimeter = {
     ...
     * ```
     */
    useTriangle(side1, side2, side3, options) {
     ...
     * ```
     */
    useTrapezoid(side1, side2, side3, side4, options) {
     ...
     * ```
     */
    useParallelogram(side1, side2, options) {
...
const volume = {
     ...
     * ```
     */
    useBox(length, width, height, options) {
     ...
     * ```
     */
    useCylinder(radius, height, options) {
     ...
     * ```
     */
    usePyramid(baseArea, height, options) {

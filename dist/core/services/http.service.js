 ...
 * ```
 */
export function useInit(apisConfig) {
 ...
 * ```
 */
export function useInitApis(apisConfig) {
    useInit(apisConfig);
}
/**
 ...
 * ```
 */
export async function useFetch(apiName, endpointName, { urlOptions, ...init } = {}) {
    let url = "";
    try {
 ...
 * ```
 */
export async function useFetchApi(apiName, endpointName, options) {
    return useFetch(apiName, endpointName, options);
}
/**
 ...
 * ```
 */
export async function useGet(apiName, endpointName, urlOptions) {
    return useFetch(apiName, endpointName, { method: "GET", urlOptions });
}
/**
 * GET helper over a registered API endpoint.
 ...
 * ```
 */
export async function useGetApi(apiName, endpointName, urlOptions) {
    return useGet(apiName, endpointName, urlOptions);
}
/**
 ...
 * ```
 */
export async function usePost(apiName, endpointName, body, urlOptions) {
    return useFetch(apiName, endpointName, {
        method: "POST",
        ...serializeBody(body),
        urlOptions,
    });
 ...
 * ```
 */
export async function usePut(apiName, endpointName, body, urlOptions) {
    return useFetch(apiName, endpointName, {
        method: "PUT",
        ...serializeBody(body),
        urlOptions,
 ...
 * ```
 */
export async function usePatch(apiName, endpointName, body, urlOptions) {
    return useFetch(apiName, endpointName, {
        method: "PATCH",
        ...serializeBody(body),
        urlOptions,
 ...
 * ```
 */
export async function useDelete(apiName, endpointName, urlOptions) {
    return useFetch(apiName, endpointName, {
        method: "DELETE",
        urlOptions,
    });

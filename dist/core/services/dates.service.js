 ...
 * ```
 */
export function useDiff(start, end) {
 ...
 * ```
 */
export function useFormat(dateInput, locale = "en", options = {}) {
    let date;
    try {
 ...
 * ```
 */
export function useAddDays(date, days) {
 ...
 * ```
 */
export function useSubtractDays(date, days) {
 ...
 * ```
 */
export function useIsEqual(date1, date2) {
 ...
 * ```
 */
export function useIsBefore(date1, date2) {
    return Temporal.PlainDate.compare(toPlainDate(date1), toPlainDate(date2)) < 0;
}
/**
 ...
 * ```
 */
export function useIsAfter(date1, date2) {
    return Temporal.PlainDate.compare(toPlainDate(date1), toPlainDate(date2)) > 0;
}
/**
 ...
 * ```
 */
export function useFirstDayOfMonth(date = Temporal.Now.plainDateISO()) {
 ...
 * ```
 */
export function useLastDayOfMonth(date = Temporal.Now.plainDateISO()) {

 ...
 * ```
 */
export async function useGetMediaStream(constraints = { video: true, audio: true }) {
 ...
 * ```
 */
export function useStopMediaStream(stream) {
    if (stream) {
 ...
 * ```
 */
export async function useGetFrontCamera() {
 ...
 * ```
 */
export async function useGetBackCamera() {
 ...
 * ```
 */
export async function useGetGeolocation(options) {
 ...
 * ```
 */
export function useWatchGeolocation(callback, options) {
    if (!isBrowser() || !navigator.geolocation)
        return null;
 ...
 * ```
 */
export async function useRequestMotionPermission() {
    if (!isBrowser())
        return false;
 ...
 * ```
 */
export function useOnDeviceOrientation(callback) {
    if (!isBrowser() || typeof DeviceOrientationEvent === "undefined")
        return null;
 ...
 * ```
 */
export function useOnDeviceMotion(callback) {
    if (!isBrowser())
        return null;
 ...
 * ```
 */
export function useVibrate(pattern) {
 ...
 */
export function useStopVibration() {
    return useVibrate(0);
}
// ============================================================
// Battery
 ...
 * ```
 */
export async function useGetBattery() {
    if (!isBrowser())
        return null;
    const nav = navigator;
    if (!nav.getBattery)

 ...
 * ```
 */
export function useAstroPathsFrom(items, options = {}) {
 ...
 * ```
 */
export async function useAstroGetStaticPaths(getCollectionFn, collectionName, options = {}) {
    try {
 ...
 * ```
 */
export function useAstroFindEntry(items, value, keyFrom) {
 ...
 * ```
 */
export function useAstroGeneratePagination(items, pageSize = 10, param = "page") {
 ...
 * ```
 */
export function useAstroPathsFromValues(values, param = "slug") {
 ...
 * ```
 */
export function useAstroExtractUniqueValues(items, keyFrom) {
